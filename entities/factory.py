...
class Factory:
    ...
    def __init__(self):
        ...
        self.littleo = NonPlayableCharacter("Little(o)", [], True)
        self.blacksmith = NonPlayableCharacter("Blacksmith", [], True)
        self.innkeeper = NonPlayableCharacter("Innkeeper", [], True)
        self.merchant = NonPlayableCharacter("Merchant", [], True)
        self.monk = NonPlayableCharacter("Monk", [], True)
        self.ferns = NonPlayableCharacter("Ferns", [], False)
        self.rina = NonPlayableCharacter("Rina", [], False)
        self.intruder = NonPlayableCharacter("Intruder", [], False)
        self.oak = NonPlayableCharacter("Oak", [], False)
        self.enzopaolo = NonPlayableCharacter("Enzo Paolo", [], False)
        self.priamo = NonPlayableCharacter("Priamo", [], False)
